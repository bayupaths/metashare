...
@section('title')
    Dashboard Super Admin - Update Model Undangan
@endsection
...
@section('content')
    <div class="page-breadcrumb">
        <div class="row">
            <div class="col-7 align-self-center">
                <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">Update Model Undangan</h3>
                <div class="d-flex align-items-center">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb m-0 p-0">
                            <li class="breadcrumb-item disabled" aria-current="page">Master Data</li>
                            <li class="breadcrumb-item" aria-current="page">
                                <a href="{{ route('invitation.index') }}" class="text-link">
                                    Data Model Undangan
                                </a>
                            </li>
                            <li class="breadcrumb-item active" aria-current="page">Update Model Undangan</li>
                        </ol>
                    </nav>
                </div>
            </div>
    ...
    <div class="container-fluid">
        <div class="card shadow px-3">
            <form action="{{ route('invitation.update', $invitationModel->id) }}" method="post"
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" name="type" class="form-control" readonly
                            value="{{ $invitationModel->type }}" id="jenisUndangan">
                    </div>
                </div>
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <select class="form-control @error('categories_id') is-invalid @enderror" id="change-category"
                            ...
                            @foreach ($categories as $category)
                                ...
                                @if ($category->id == $invitationModel->categories_id)
                                    <option value="{{ $invitationModel->categories_id }}" selected>
                                        {{ $invitationModel->category->name }}
                                    </option>
                                @else
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="text" name="name" id="modelName"
                            ...
                            is-invalid @enderror"
                            value="{{ $invitationModel->name ?? old('name') }}">
                        @error('name')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <div class="input-group">
                        <input type="number" name="price" id="modelPrice"
                            ...
                            is-invalid @enderror"
                            value="{{ $invitationModel->price ?? old('price') }}">
                        @error('name')
                            <div class="invalid-feedback">
                                <strong>{{ $message }}</strong>
                            </div>
                ...
                <div class="row" id="preview-image-one">
                    <div class="text-center">
                        <img id="coverOne" src="{{ Storage::url($invitationModel->cover_one) ?? '' }}"
                ...
                <div class="row" id="preview-image-two">
                    <div class="text-center">
                        <img id="coverTwo" src="{{ Storage::url($invitationModel->cover_two) ?? '' }}"
                            class="rounded w-25 mx-auto d-block" alt="prview-image">
                    </div>
                </div>
